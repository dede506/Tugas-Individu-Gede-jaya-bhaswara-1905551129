        ...
        builder.setItems(option, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                switch (i){
                    ...
                    case 1:
                            Intent  modifyActivity = new Intent(context,  com.jayabhaswara.progmob.ModifyActivity.class);
                    ...
                    case 2:
                        ...
                        userList = db.selectUserData();
                        com.jayabhaswara.progmob.MainActivity.setupRecyclerView(context, userList, com.jayabhaswara.progmob.MainActivity.recyclerView);
