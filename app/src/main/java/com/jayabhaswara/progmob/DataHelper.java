...
public class DataHelper extends SQLiteOpenHelper {
    ...
    public void insert (com.jayabhaswara.progmob.User user) {
    ...
    public List<com.jayabhaswara.progmob.User> selectUserData() {
        ArrayList<com.jayabhaswara.progmob.User> users = new ArrayList<com.jayabhaswara.progmob.User>();
        ...
        while (cursor.moveToNext()) {
            ...
            com.jayabhaswara.progmob.User user = new com.jayabhaswara.progmob.User();
            user.setId(id);
    ...
    public void update(com.jayabhaswara.progmob.User user){
        SQLiteDatabase db = getReadableDatabase();
        ContentValues values = new ContentValues();
